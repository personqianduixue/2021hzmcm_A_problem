...
writematrix(result1_reshape,'.\DE76\result1_reshape.xlsx')
...
writematrix(result2_reshape,'.\DE76\result2_reshape.xlsx')
...
title('图像1与瓷砖lab颜色匹配网络(DE76)')
print(gcf,'..\img\图像1与瓷砖lab颜色匹配网络DE76','-dpng','-r600')
...
view(-55,23.4)
xlabel('a');ylabel('b');zlabel('L');
title('图像2与瓷砖lab颜色匹配网络(DE76)')
print(gcf,'..\img\图像2与瓷砖lab颜色匹配网络DE76','-dpng','-r600')
